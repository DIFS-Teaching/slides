...
- **OWL 2** (W3C Rec 2009, 2. vydání 2012) -- výrazně bohatší: ekvivalence, disjunktnost, kardinality, inverzní vlastnosti
	- Profily **EL / QL / RL** -- omezené podjazyky, u kterých je odvozování rychlé
	- Odvozování (*reasoning*) dělají HermiT, ELK, Openllet -- a je drahé
...
schema:taxID  a  owl:InverseFunctionalProperty .
# Dvě firmy se stejným IČO jsou tatáž firma.
```

- `owl:sameAs` -- **tytéž entity** popsané v různých datasetech
- `owl:differentFrom` -- explicitně různé; různá IRI sama o sobě nestačí
- `owl:InverseFunctionalProperty` -- **deklarovaný klíč** (IČO!); identita se odvodí sama
- ??⚠ Formálně to znamená ``identické ve všech ohledech''
- ??V praxi se používá volně -- a **přenáší chyby napříč datasety** (*sameAs smell*)
...
Chybějící tvrzení ≠ nepravda. &bdquo;O téhle firmě nevím cenu&ldquo; není
&bdquo;tahle firma nemá cenu&ldquo;.
...
<p class="fragment" style="text-align: center; font-size: 110%; margin-top: 0.1em;">Z úvodní přednášky: &bdquo;Volnost ve struktuře dat &ndash; platím kontrolou, kterou by odvedlo schéma.&ldquo;<br><strong>SHACL je ta kontrola koupená zpátky.</strong></p>

Note:
Přímý citát z tabulky v úvodní přednášce. RDF je schema-free, takže se za to
platí -- a SHACL je způsob, jak si tu kontrolu vrátit dobrovolně a jen tam,
kde ji chci.

---

# Slovníky, které opravdu potkáte
...
<p class="fragment" style="text-align: center; font-size: 115%; margin-top: 0.2em;">Vlastní ontologii tvořte až <strong>naposled</strong>. Napřed hledejte existující.</p>
