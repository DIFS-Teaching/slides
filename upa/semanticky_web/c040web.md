...
- `<script type="application/ld+json">` je **RDF v HTML**
- IRI v něm pocházejí ze **slovníku** -- typicky schema.org
- Nástroj (`extruct` + `rdflib`) z nich udělá trojice
- ??Nad trojicemi se dotazujete **stejným SPARQL** jako nad Wikidaty

<p class="fragment" style="font-size: 130%; text-align: center; margin-top: 0.8em;">Anotovaná stránka je malý kousek propojených dat. <br>Zbývá se podívat na ty velké.</p>
